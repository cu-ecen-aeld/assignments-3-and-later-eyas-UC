...
void test_validate_my_username()
{
     ...
     */
    const char *actual_string = malloc_username_from_conf_file();
    const char * expected_string = my_username();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(actual_string , expected_string, "They are not equal dude!");
    free((void*)actual_string);
